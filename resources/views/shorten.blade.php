...
@section('container')
    @if (Session::has('id'))
    	<div style="text-align:right;">
    		...
    		<p><a href="{{ asset('api/register') }}">API Url Dashboard</a></p>
    	</div>		
    	<div class="container">
			<h3> WELCOME {{ session('name') }}</h3>
			<h1 class="title"> NORMAL DASHBOARD </h1>
			...
			<table style="width:100%">
                ...
                <tr>
					...
					<td><form action="{{ URL::route('normalstate', [$paginatedView['links'][$i]->hash, $currentPage])}}" method="post">
